...
export class AddAllTables1790291403173 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "customer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(150) NOT NULL, "lastName" character varying(150) NOT NULL, "dni" character varying(50) NOT NULL, "email" character varying(200) NOT NULL, CONSTRAINT "PK_a7a13f4cacb744524e44dfdad32" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "transaction-status" ("id" SERIAL NOT NULL, "status" character varying(50) NOT NULL, CONSTRAINT "PK_d82f9cc71521130c60cf4850230" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "order_item" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "transaction_id" uuid NOT NULL, "product_id" uuid NOT NULL, "price" numeric(12,2) NOT NULL, "quantity" integer NOT NULL, CONSTRAINT "PK_d01158fe15b1ead5c26fd7f4e90" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "delivery" ADD CONSTRAINT "FK_e1dd06d37dd9bf4271417d002b9" FOREIGN KEY ("transaction_id") REFERENCES "transaction"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "order_item" ADD CONSTRAINT "FK_9a1bb28fa50a4d18d6be17d2180" FOREIGN KEY ("transaction_id") REFERENCES "transaction"("uuid") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "order_item" DROP CONSTRAINT "FK_9a1bb28fa50a4d18d6be17d2180"`);
